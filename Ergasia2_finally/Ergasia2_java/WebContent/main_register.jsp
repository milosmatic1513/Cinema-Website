...
<table width='100%' >
  <tr>
   ...
   <td width='25%'><form width='100%' method = "post" action = "Profile"  ><button type = "submit"  class= "btn btn-success btn-block frm-block"> <i class="fas fa-flag"></i> Register</button></form></td>
